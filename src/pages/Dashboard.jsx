...
const darkBackground = "#050A17"; // لون الوضع المظلم
...
export default function Dashboard() {
  ...
  <ListItem
    ...
    sx={{
      backgroundColor: activeItem === "Landing Page" ? activeColor : "inherit",
  ...
  return (
    ...
    >
      <CssBaseline />
      {isMobile && (
  <AppBar position="fixed" sx={{ backgroundColor: darkMode ? darkBackground : "#fff" }}>
